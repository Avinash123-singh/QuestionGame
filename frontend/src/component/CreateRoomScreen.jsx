    ...
    >
      <Container maxWidth="md" sx={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        >
          ...
          <Box sx={{ textAlign: 'center', mb: { xs: 2, sm: 2.5 }, mt: 1, flexShrink: 0 }}>
          ...
          <Box sx={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', gap: { xs: 2, sm: 2.5 } }}>
            <Box sx={{ flexShrink: 0 }}>
            ...
            <Box sx={{ flexShrink: 0 }}>
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="all" sx={{ color: '#1a0a2e', background: '#f5f5f5' }}>All Categories</MenuItem>
                  <MenuItem value="trivia" sx={{ color: '#1a0a2e', background: '#f5f5f5' }}>Trivia</MenuItem>
                  <MenuItem value="movies" sx={{ color: '#1a0a2e', background: '#f5f5f5' }}>Movies</MenuItem>
                  <MenuItem value="history" sx={{ color: '#1a0a2e', background: '#f5f5f5' }}>History</MenuItem>
                  <MenuItem value="science" sx={{ color: '#1a0a2e', background: '#f5f5f5' }}>Science</MenuItem>
                </StyledSelect>
              </FormControl>
            </Box>
